...
ROS_LIBS_OTHER = $(foreach lib, $(shell rospack libs-only-other roscpp), $(lib))
...
%: ros/%.cc
	$(CXX) -I./include $(ROS_CXXFLAGS) $(IPC_BRIDGE_CXXFLAGS) -lstdc++ $(IPC_LFLAGS) $(ROS_LFLAGS) $^ -o bin/$@ $(ROS_LIBS_OTHER) $(ROS_LIBS) -lipc
